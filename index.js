...
lib.ssMetadata = [
		{name:"index_atlas_1", frames: [[0,388,1379,399],[1381,694,323,253],[0,0,1859,386],[1706,694,263,232],[1381,388,462,304]]}
];
...
p.nominalBounds = new cjs.Rectangle(0,0,2212,436);
...
p.nominalBounds = new cjs.Rectangle(0,0,2636,622);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(21.15,3.35,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.textCuba, new cjs.Rectangle(21.2,3.4,1106,218), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(142.6,349.9,0.5,0.5);

	this.instance_1 = new lib.CachedBmp_6();
	this.instance_1.setTransform(1.45,6.15,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_1},{t:this.instance}]}).wait(1));

	// Layer_1
	this.instance_2 = new lib.CachedBmp_9();
	this.instance_2.setTransform(-31.2,-29.1,0.5,0.5);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(9.25,19.4,0.5,0.5);
...
(lib.buttonsemula = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(45.95,5.25,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("rgba(255,0,0,0)").ss(1,1,1).p("Aw8tUMAh5AAAQDUAACWCWQCWCWAADUIAAKqQAADUiWCWQiWCWjUAAMgh5AAAQjUAAiWiWQiWiWAAjUIAAqqQAAjUCWiWQCWiWDUAAg");
	this.shape.setTransform(159.7,85.35);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FF9900").s().p("Aw8NVQjUAAiWiVQiWiXAAjUIAAqqQAAjTCWiXQCWiVDUAAMAh5AAAQDUAACWCVQCWCXAADTIAAKqQAADUiWCXQiWCVjUAAg");
	this.shape_1.setTransform(159.7,85.35);
...
p.nominalBounds = new cjs.Rectangle(-1,-1,321.4,172.7);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FFFFFF").s().p("Ah8GYQielGCOldIgsgNIkuhRIJDlPIGKJVIldheQhmHMF7GsQggACgeAAQlNAAiQkhg");
	this.shape.setTransform(48.75,69.6969);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.arrow, new cjs.Rectangle(0,0,97.5,139.4), null);
...
if (reversed == null) { reversed = false; }
	...
	this.frame_0 = function() {
		...
		function YouWonGame(){
			...
			root.maze.visible=false;
			root.buttonHome.visible=true;
			
			
		}
		
		this.buttonHome.addEventListener("click",KeKgBerop);
		
		function KeKgBerop(){
		
			root.bg.visible=true;
			root.title.visible=true;
			root.startHome.visible=true;
			root.textWin.visible=false;
			root.hantu2.visible=false;
			root.buttonHome.visible=false;
			root.bg2.visible=false;
	...
	// berop
	this.buttonHome = new lib.buttonsemula();
	this.buttonHome.name = "buttonHome";
	this.buttonHome.setTransform(988.65,885.1,1,1,0,0,0,159.7,85.4);
	new cjs.ButtonHelper(this.buttonHome, 0, 1, 1);

	this.timeline.addTween(cjs.Tween.get(this.buttonHome).wait(1));
	...
	this.arrow.setTransform(290.65,248.3,0.9426,0.9999,0,-44.9994,135.002,48.6,69.8);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CachedBmp_12.png?1706622989967", id:"CachedBmp_12"},
		{src:"images/CachedBmp_15.png?1706622989967", id:"CachedBmp_15"},
		{src:"images/CachedBmp_10.png?1706622989967", id:"CachedBmp_10"},
		{src:"images/CachedBmp_9.png?1706622989967", id:"CachedBmp_9"},
		{src:"images/CachedBmp_8.png?1706622989967", id:"CachedBmp_8"},
		{src:"images/CachedBmp_7.png?1706622989967", id:"CachedBmp_7"},
		{src:"images/CachedBmp_5.png?1706622989967", id:"CachedBmp_5"},
		{src:"images/CachedBmp_4.png?1706622989967", id:"CachedBmp_4"},
		{src:"images/CachedBmp_2.png?1706622989967", id:"CachedBmp_2"},
		{src:"images/CachedBmp_1.png?1706622989967", id:"CachedBmp_1"},
		{src:"images/index_atlas_1.png?1706622989918", id:"index_atlas_1"}
	],
	preloads: []
};
